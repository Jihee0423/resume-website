      ...
      <div className="max-w-6xl mx-auto px-6 py-24 relative z-10 w-full">
        <div className="max-w-3xl">
          <h1 className="text-5xl md:text-6xl lg:text-7xl leading-[1.1] mb-8 font-light">
            ...
            <span className="text-[#2A7F7F] font-medium">data-driven systems</span>
            <span className="text-gray-900"> that embody precision and deliver insight</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed mb-10">
            Leading quantitative research and analytics at tech companies, 
            building financial models and data systems that drive decisions.
          </p>
